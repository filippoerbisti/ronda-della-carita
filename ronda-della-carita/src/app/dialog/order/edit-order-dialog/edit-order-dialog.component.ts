...
export class EditOrderDialogComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    try {
      let response_order = await axios.get("https://backoffice-ronda.herokuapp.com/api/auth/order/" + orderId);
      ...
      let response_clothe = await axios.get("https://backoffice-ronda.herokuapp.com/api/auth/clothe/edit/" + clotheId);
