...
export class StoricoAccessiComponent implements OnInit {
  ...
  async ngOnInit() {
    this.isLoading = true;
    try {
      let response = await axios.get("https://backoffice-ronda.herokuapp.com/api/auth/history");
      console.log(response.status);
      console.log(response.data);
      this.histories = response.data;

      let response_access_today = await axios.get("https://backoffice-ronda.herokuapp.com/api/auth/history/accessi/today");
  ...
  async filterHistory() {
    ...
    try {
      let response_filter = await axios.get("https://backoffice-ronda.herokuapp.com/api/auth/history/filt/" + search);
